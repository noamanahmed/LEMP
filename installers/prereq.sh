...
binaries_array=( "software-properties-common" "screen" "htop"  "nload" "curl" "wget" "git" "unrar" "unzip" "zip" "speedtest-cli gzip" "pv" "logrotate" "rig" "runuser" "gnupg" "ca-certificates" "gnupg2" "sqlite3" "jq" "bc" "xclip" "tree" "dnsutils")
