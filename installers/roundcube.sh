...
sed -i "s/{{db_name}}/$database_name/"  $user_root/config/config.local.php
sed -i "s/{{db_username}}/$database_user/"  $user_root/config/config.local.php
sed -i "s/{{db_password}}/$database_password/"  $user_root/config/config.local.php
