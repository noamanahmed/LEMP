...
apt-get install php8.0-common php8.0-fpm php8.0-cli php8.0-fileinfo php8.0-mysql php8.0-xml php8.0-curl php8.0-gd php8.0-imagick php8.0-cli php8.0-dev php8.0-imap php8.0-mbstring php8.0-opcache php8.0-soap php8.0-zip php8.0-redis -y

apt-get install php7.4 -y
apt-get install php7.4-common php7.4-fpm php7.4-cli php7.4-fileinfo php7.4-mysql php7.4-xml php7.4-curl php7.4-gd php7.4-imagick php7.4-cli php7.4-dev php7.4-imap php7.4-mbstring php7.4-opcache php7.4-soap php7.4-zip php7.4-redis -y
