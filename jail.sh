...
binaries_array=("xterm" "ls" "date" "rm" "rmdir" "php" "wp" "git" "wget" "composer" "composer1" "composer2" "nano" "stty" "grep" "find" "clear" "du" "cp" "touch" "cat")
...
for path in ${path_array[@]}; do
    ...
    echo "chmod 640 $(find \"$chroot_path/$path\" -type f)"
done
