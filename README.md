...
```sh
--without_nginx --without_mysql --without_php --without_mongodb --without_nvm --without_proftpd --without_letsencrypt --without_redis --without_docker --without_composer --without_java --without_meilisearch --without_jenkins --without_jailkit --without_scripts --without_hostname_site --without_phpmyadmin --without_postgres --with_elk --with_kafka --with_rabbitmq --with_netdata --with_sentry --with_glitchtip --with_monit --with_kernel --with_mailhog --slack_notification_webhook https://hooks.slack.com/services/XXXXXXX/XXXXXX/XXXXXXXXXX --uptime_robot_key YOUR_MAIN_API_KEY              
```
